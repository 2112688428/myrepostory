package org.bx.idgenerator.server.exception;
...
public class GlobalExceptionAdvice {
    ...
    @ResponseBody
    @ExceptionHandler({ClockBackRuntimeException.class})
    public ResultWrapper bizException(ClockBackRuntimeException e) {
        log.error("时钟回拨异常:{}", e);
        return ResultWrapper.builder().code(StateCode.ERROR.code()).data(e.getMessage()).build();
    }
